                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="subcategory_id" id="subcategory_id">
                                                ...
                                                <option value="{{ $row->id }}" @if($row->id==$product->subcategory_id)
                                                    selected @endif > -- {{ $row->subcategory_name }}</option>
                                                @endforeach
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="childcategory_id" id="childcategory_id">
                                                ...
                                                <option value="{{ $child->id }}" @if($child->
                                                    id==$product->childcategory_id) selected @endif>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="brand_id">
                                                ...
                                                <option value="{{ $row->id }}" @if($row->id==$product->brand_id)
                                                    selected @endif>{{ $row->brand_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="pickup_point_id">
                                                ...
                                                <option value="{{ $row->id }}" @if($row->id==$product->pickup_point_id)
                                                    selected @endif >{{ $row->pickup_point_name  }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputEmail1">Main Thumbnail <span
                                    ...
                                    <div class="">
                                        <table class="table table-bordered" id="dynamic_field">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <img alt="" src="{{asset('files/product/'.$image)}}"
                                    ...
                                    <div class="card p-4">
                                        ...
                                        checked @endif data-bootstrap-switch data-off-color="danger"
                                        data-on-color="success" data-toggle="toggle" data-size="sm">
                                    </div>

                                    <div class="card p-4">
                                        <h6>Today Deal</h6>
                                        <input type="checkbox" name="today_deal" value="1" @if($product->today_deal==1)
                                        checked @endif data-bootstrap-switch data-off-color="danger"
                                        data-on-color="success" data-toggle="toggle" data-size="sm">
                                    </div>
                                    ...
                                    <div class="card p-4">
                                        ...
                                        data-off-color="danger" data-on-color="success" data-toggle="toggle"
                                        data-size="sm">
                                    </div>

                                    <div class="card p-4">
                                        <h6>Trendy Product</h6>
                                        <input type="checkbox" name="trendy" value="1" @if($product->status==1) checked
