                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="row p-2">
                                ...
                                <div class="form-group col-2">
                                    <label>product_slider</label>
                                    <select class="form-control submitable" name="product_slider" id="product_slider">
                                        <option value="1">All</option>
                                        <option value="1">Active</option>
                                        <option value="0">Inactive</option>
                                    </select>
...
<script type="text/javascript">
	$(function products(){
      ...
      "ajax":{
        ...
        "data":function(e) {
          ...
          e.status =$("#status").val();
          e.product_slider =$("#product_slider").val();
    ...
    //deactive product_slider
	$('body').on('click','.deactive_product_slider', function(){
	    var id=$(this).data('id');
		var url = "{{ url('product/not-product-slider') }}/"+id;
		$.ajax({
			url:url,
			type:'get',
			success:function(data){  
    ...
    //Active product_slider
	$('body').on('click','.active_product_slider', function(){
	    var id=$(this).data('id');
		var url = "{{ url('product/active-product-slider') }}/"+id;
		$.ajax({
			url:url,
			type:'get',
			success:function(data){  
